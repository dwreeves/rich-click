"""
This module mostly contains decorators that wrap the click decorators but with appropriate types
so that users can use rich-click with Mypy.

There is also a new decorator, `rich_config()`, defined in this module.
"""
...
def rich_config(
    ...
    def decorator(obj: FC) -> FC:
        ...
        if isinstance(obj, (RichCommand, RichGroup)):
            ...
            raise TypeError("`rich_config` requires a `RichCommand` or `RichGroup`.")
        return obj
